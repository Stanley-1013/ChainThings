...
export default function SettingsPage() {
  ...
  async function enableHedyWorkflow() {
    ...
    try {
      ...
      toast.success(json.data.alreadyExists
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <PageHeader title="Settings" description="Manage your integrations and preferences" />

      {/* Hedy.ai Integration Section */}
        ...
        <CardContent className="pt-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/20 border rounded-lg p-4 space-y-4">
              ...
              <Button
                ...
                className={cn(hasWorkflow && "bg-green-100 text-green-800 hover:bg-green-100 border-green-200")}
              >
                {hedySetupLoading ? (
          ...
          {webhookUrl && (
            <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="flex items-center gap-2 text-xs bg-blue-50 text-blue-800 p-3 rounded-md border border-blue-100">
